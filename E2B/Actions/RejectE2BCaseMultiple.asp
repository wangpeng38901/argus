...
<head>
    <!-- Page Title -->
    <title><%=GetTranslationData("REJECT_E2B_CASES")%></title>
...
async function fn_password_verify()
{
    ...
    {
        bPasswordOK = false;
        await MessageBoxRes("GENERAL_WARNING", '<%=GetTranslationData("REJECT_E2B_CASES")%>', sErrMsg); 
        ...
        <table class="table border" width="100%" height="100%" cellspacing="0" cellpadding="0">
            <tr height="25px">
                <td class="section-header-middle">
                    <% BuildLocalLabel("REJECT_E2B_CASES").SetStyleSheet("label label-section").Render()%>
                </td>
            </tr>
            <tr>
                <td class="padding-all">
                    <table class="table inner-table" width="100%" height="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tr height="50px">
                            <td colspan="2">
                                <%BuildLocalLabel("REJECT_MULTIPLE_E2B_CASE_INSTRUCTION").Render()%>
                            </td>
                        </tr>
                        <tr height="20px">
                            <td>
