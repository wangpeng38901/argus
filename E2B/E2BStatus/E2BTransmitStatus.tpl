<tr id="data_row_[[ROW_NUMBER]]" name="data_row_[[ROW_NUMBER]]" class='[[ROW_CLASS]]' >
      ...
      <table cellpadding="0" cellspacing="0" width="30px">
        ...
        <tr class='[[ROW_CLASS]]' >
          <td valign="middle" align="left">
            <a href="#" onclick="fn_OpenAckStatus('[[RPT_E2B_LMESSAGE_ID]]', '[[RPT_E2B_MESSAGE_TYPE]]');" style="text-decoration:none;">
    ...
    <td valign="middle" class="alc-header">
            <input id="bbfTpl_state_[[ROW_NUMBER]]" name="Tpl_Agency_[[ROW_NUMBER]]" class="textbox-worklist" style="
                   width: 100%; background-color: [[ROW_COLOR]]" value="[[RPT_E2B_AGENCY_NAME]]"  readonly />
            <input id="bbfTpl_state_[[ROW_NUMBER]]" name="bbfTpl_STATE_[[ROW_NUMBER]]" class="textbox-worklist" style="
                  width: 100%; background-color: [[ROW_COLOR]];" value="[[RPT_E2B_CONTROL_NO]]"  readonly />
    </td>
    <!-- 3 -->
    ...
    <td valign="middle" align="left" class="alc-header">
      <table cellpadding="0" cellspacing="0" width='100%'>
        <tr class='[[ROW_CLASS]]' width='100%'>
          <td valign="middle" align="left" width='100%'>
            <input id="bbfTpl_product_[[ROW_NUMBER]]" name="bbfTpl_product_[[ROW_NUMBER]]" class="textbox-worklist" style="width: 90%;
                background-color: [[ROW_COLOR]];" value="[[RPT_E2B_LMESSAGENUMB]]" readonly />
          </td>
        </tr>
        <tr class='[[ROW_CLASS]]' width='100%'>
          <td valign="middle" align="left" width='100%'>
            <input id="bbfTpl_Diagnosis_[[ROW_NUMBER]]" name="bbfTpl_Diagnosis_[[ROW_NUMBER]]" class="textbox-worklist" style="width: 90%;
        ...
        <tr class='[[ROW_CLASS]]'>
          <td valign="middle" align="left">-->
            <input id="bbfTpl_flt_[[ROW_NUMBER]]" name="bbfTpl_flt_[[ROW_NUMBER]]" class="textbox-worklist" style="width: 100%;
                  background-color: [[ROW_COLOR]];" value="[[RPT_E2B_TRANSMIT_DATE]]" readonly />
      <!--    </td>
        </tr>
      </table>-->
    ...
    <td valign="middle" align="left" class="alc-header">
      <!--<table cellpadding="0" cellspacing="0">
        <tr class='[[ROW_CLASS]]'>
          <td valign="middle" align="left">-->
            <input id="fname_[[ROW_NUMBER]]" name="fname_[[ROW_NUMBER]]" class="textbox-worklist" style="width: 100%;
                  background-color: [[ROW_COLOR]];" value="[[RPT_E2B_EDI_TRACKING_ID]]" readonly />
        ...
        <tr class='[[ROW_CLASS]]'>
          <td valign="middle" align="left">-->
            <input id="bbfTpl_flt_[[ROW_NUMBER]]" name="bbfTpl_flt_[[ROW_NUMBER]]" class="textbox-worklist" style="width: 100%;
                    background-color: [[ROW_COLOR]];" value="[[RPT_E2B_EDI_TRANSMIT_DATE]]" readonly />
       <!--   </td>
        </tr>
      </table>-->
    ...
    <td valign="middle" align="left" class="alc-header">
      <table cellpadding="0" cellspacing="0" width='100%'>
        ...
        <tr class='[[ROW_CLASS]]' width='100%'>
          <td valign="middle" align="left" width='100%'>
            <input id="bbfTpl_FOLLOWUP_[[ROW_NUMBER]]" name="bbfTpl_FOLLOWUP_[[ROW_NUMBER]]" class="textbox-worklist" style="width:90%;
                  background-color: [[ROW_COLOR]];" value="[[RPT_E2B_EDI_COMPLETE_DATE]]" readonly />
          </td>
        </tr>
      </table>
    </td>
