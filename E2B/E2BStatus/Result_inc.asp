                ...
                <tr style="height: 36px;">
                    <td>
                        <div id="Div1" class="scroll_hide" style="width: 100%; overflow-y: scroll;">
                            <table id="result_table" class="table inner-table" cellspacing="0" cellpadding="2" style="width: 100%;">
                                <col width="5%" />
                                <col width="20%" />
                                <col width="12%" />
                                <col width="13%" />
                                ...
                                <tr class="tblheader-lightblue" style="height: 36px;">
                                    <th class="grd-header">
                                        <table cellpadding='0' cellspacing='0' width="100%">
                                            ...
                                            <tr style="cursor: pointer">
                                                <td width="100%" align="Center" onclick="fn_Sort(1, <%= lNextSortOrder %>);">
                                    ...
                                    <th class="grd-header">
                                        <table cellpadding='0' cellspacing='0' width="100%">
                                            ...
                                            <tr style="cursor: pointer">
                                                <td width="100%" onclick="fn_Sort(10, <%= lNextSortOrder %>);">
                                        ...
                                        <table cellpadding='0' cellspacing='0' width="100%">
                                            <tr width="100%">
                                                <td width="100%" onclick="fn_Sort(3, <%= lNextSortOrder %>);">
                                                    ...
                                                    <%If (lCurrentSort = 3) Then response.Write(sArrowStr) %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onclick="fn_Sort(4, <%= lNextSortOrder %>);">
                                        ...
                                        <table cellpadding='0' cellspacing='0' width="100%">
                                            <tr>
                                                <td onclick="fn_Sort(5, <%= lNextSortOrder %>);">
                                                    <%BuildLabelDirect("Total Reports").SetStyleSheet("label label-no-padding").Render()%>
                                                    <%If (lCurrentSort = 5) Then response.Write(sArrowStr) %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onclick="fn_Sort(6, <%= lNextSortOrder %>);">
                                                    <%BuildLabelDirect("Rejected Reports").SetStyleSheet("label label-no-padding").Render()%>
                                        ...
                                        <table cellpadding='0' cellspacing='0' width="100%">
                                            ...
                                            <tr>
                                                <td onclick="fn_Sort(8, <%= lNextSortOrder %>);">
                                                    <%BuildLabelDirect("Received from EDI").SetStyleSheet("label label-no-padding").Render()%>
