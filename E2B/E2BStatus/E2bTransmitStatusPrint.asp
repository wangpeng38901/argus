...
<head>
    <!-- Page Title -->
    <title>Transmit Status Print List</title>
...
<%
Dim oMessage, bSuccess, lViewAll, sSortString, oOutMsg, sDocId, sUserID
